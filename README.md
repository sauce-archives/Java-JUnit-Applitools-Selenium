...
2. Sauce Labs Credentials
    * In the terminal, export your Sauce Labs credentials as environmental variables:
    ...
    ```
3. Applitools Credentials
    * In the terminal, export your Applitools Eyes API Key as environmental variables:
    ```
...
4. Project Dependencies
    * Check that packages are available
    ```
    $ cd Java-JUnit-Applitools-Selenium
    $ mvn test-compile
    ```
...
##### [Applitools Documentation](https://applitools.atlassian.net//wiki/display/Java/Applitools+Eyes+Wiki)
